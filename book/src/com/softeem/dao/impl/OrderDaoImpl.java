...
public class OrderDaoImpl extends BaseDao implements OrderDao {
    ...
    public void save(Order order) throws SQLException {
        ...
        queryRunner.update(connection, sql, order.getOrderId(), order.getCreateTime(), order.getPrice(),
    ...
    public List<Order> page(Integer pageNumber) throws SQLException {
        ...
        return queryRunner.query(sql, new BeanListHandler<>(Order.class, getProcessor()), (pageNumber - 1) * pageSize, pageSize);
    }
